...
{
    /// <summary>
    /// Client minimal pour l'API SteamGridDB (recherche par NOM). Copié
    /// tel quel depuis DiscShelf -- logique générique, indépendante du
    /// type de support (disque ou cartouche).
    /// </summary>
