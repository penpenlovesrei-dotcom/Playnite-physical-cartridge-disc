...
namespace DiscShelf.Services
{
    ...
    public class GameSlotManager
    {
        ...
        /// <summary>
        /// URI ouvrant le configurateur pour un serial donné. Sert d'action
        /// de lancement quand le disque n'est pas encore configuré.
        ///
        ...
        /// </summary>
        public const string ConfigureUriFormat = "playnite://discshelf/configure/{0}";
            ...
            UserLibraryEntry userEntry)
        {
            ...
            {
                logger.Info(
                    $"GameSlotManager : pas d'entrée UserLibrary (ou émulateur introuvable) pour {identity.Serial}, action de configuration proposée."
                );
                ...
                actions.Add(new GameAction
                {
                    ...
                    Path = string.Format(ConfigureUriFormat, identity.Serial),
                    IsPlayAction = true
                });
            }
